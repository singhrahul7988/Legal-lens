...
--
-- Class LegalDoc as table legal_doc
--
...
-- Indexes
CREATE INDEX "session_idx" ON "legal_doc" USING btree ("sessionId");

--
-- Class UserImageData as table user_image_data
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('legal_lens', '20260130143027051', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260130143027051', "timestamp" = now();
