...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:legal_lens_server/src/generated/ai_chat_response.dart' as _i5;
import 'package:legal_lens_server/src/generated/ai_chat_request.dart' as _i6;
import 'package:legal_lens_server/src/generated/draft_generation_response.dart'
    as _i7;
...
import 'package:legal_lens_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _UserImageEndpoint userImage;
}
...
class _AiEndpoint {
  ...
  _i3.Future<_i5.AiChatResponse> chat(
    _i1.TestSessionBuilder sessionBuilder,
    _i6.AiChatRequest request,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.AiChatResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i7.DraftGenerationResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _DocumentEndpoint {
  ...
  _i3.Future<_i9.LegalDoc> createDocument(
    _i1.TestSessionBuilder sessionBuilder,
    _i9.LegalDoc doc,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'doc': doc}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<_i9.LegalDoc> analyzeDocument(
    _i1.TestSessionBuilder sessionBuilder,
    int docId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'docId': docId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i9.LegalDoc>> getDocumentsBySession(
    _i1.TestSessionBuilder sessionBuilder,
    String sessionId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'document',
            method: 'getDocumentsBySession',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'document',
          methodName: 'getDocumentsBySession',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i9.LegalDoc>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _UserImageEndpoint {
  ...
  _i3.Future<void> removeUserImage(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
